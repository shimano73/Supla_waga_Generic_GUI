...
void setup() {
  ...
  new Supla::Sensor::H711(HX711_DOUT, HX711_CLK, String (ConfigManager->get(KEY_LPG_CALIBRATIONS)->getValue()).toInt(), String (ConfigManager->get(KEY_LPG_EMPTY)->getValue()).toInt(),String (ConfigManager->get(KEY_LPG_FULL)->getValue()).toInt());
